...
|               研发模式               |               自动化模式                |
| :----------------------------------: | :-------------------------------------: |
| ![Skyway 研发模式](./images/dev.png) | ![Skyway 自动化模式](./images/vibe.png) |
...
[git-contributor 说明](https://github.com/xudafeng/git-contributor)，自动生成时间：`Fri Mar 20 2026 15:14:14 GMT+0000`。
